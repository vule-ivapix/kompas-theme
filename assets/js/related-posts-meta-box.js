( function() {
	var wrap     = document.getElementById( 'kompas-related-posts-wrap' );
	if ( ! wrap ) return;

	var input    = document.getElementById( 'kompas-related-posts-ids' );
	var searchEl = document.getElementById( 'kompas-related-posts-search' );
	var resultEl = document.getElementById( 'kompas-related-posts-results' );
	var listEl   = document.getElementById( 'kompas-related-posts-list' );
	var maxPosts = 6;
	var searchTimer;
	...
	function renderList( ids ) {
		...
		fetch( url, { credentials: 'same-origin', headers: { 'X-WP-Nonce': kompasRelatedData.nonce } } )
